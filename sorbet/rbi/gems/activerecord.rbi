...
class Arel::Attributes::Attribute < Anonymous_Struct_31
  def able_to_type_cast?; end
  def lower; end
...
class Arel::Visitors::Dot::Edge < Anonymous_Struct_32
end
...
class ActiveRecord::Type::Time::Value < Anonymous_Delegator_33
end
...
class ActiveRecord::Type::Serialized < Anonymous_Delegator_34
  def accessor; end
...
class ActiveRecord::Core::InspectionMask < Anonymous_Delegator_35
  def pretty_print(pp); end
end
...
class ActiveRecord::Locking::LockingType < Anonymous_Delegator_36
  def deserialize(value); end
  def encode_with(coder); end
  def init_with(coder); end
  def serialize(value); end
...
class ActiveRecord::AttributeMethods::TimeZoneConversion::TimeZoneConverter < Anonymous_Delegator_37
  def cast(value); end
